    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mb-16 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 text-white" style={{ backgroundColor: '#1C3D5A' }}>1</div>
              <h5 className="font-semibold mb-2" style={{ color: '#1F2933' }}>Apply in advance</h5>
              <p className="text-sm" style={{ color: '#1C3D5A' }}>Submit your application at least 3 weeks before your visit. CDCR background checks take time and cannot be expedited.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 text-white" style={{ backgroundColor: '#1C3D5A' }}>2</div>
              <h5 className="font-semibold mb-2" style={{ color: '#1F2933' }}>Provide required information</h5>
              <p className="text-sm" style={{ color: '#1C3D5A' }}>CDCR requires your legal name, Social Security Number, and a valid, non-expired Driver's License or Passport to verify identity for prison entry.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 text-white" style={{ backgroundColor: '#1C3D5A' }}>3</div>
              <h5 className="font-semibold mb-2" style={{ color: '#1F2933' }}>We coordinate next steps</h5>
              <p className="text-sm" style={{ color: '#1C3D5A' }}>Once submitted, our team reviews your application and contacts you if anything is missing. We'll use your contact information to coordinate clearance status, scheduling, and arrival logistics.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mb-4" style={{ color: '#1C3D5A' }}>Please make sure: Your legal name matches your ID exactly. Your ID is valid and not expired. You can submit at least 3 weeks before your visit.</p>
          <p style={{ color: '#1C3D5A' }}>You'll be asked for your SSN and ID in the next step. If you're not ready, you may want to review visitor guidelines first.</p>
        </div>

        <div className="mb-16 text-center">
          <h3 className="text-2xl font-semibold mb-4" style={{ color: '#1F2933' }}>Know Before You Go</h3>
          <p className="mb-4" style={{ color: '#1C3D5A' }}>San Quentin operates under strict rules to protect everyone inside the facility. Following these guidelines helps ensure a smooth and respectful visit.</p>
          <p className="mb-4" style={{ color: '#1C3D5A' }}>
          ...
          <p style={{ color: '#1C3D5A' }}>
            ...
            <a href="https://link.sanquentinskunkworks.org/SQFAQ" target="_blank" rel="noopener noreferrer" className="font-semibold hover:underline" style={{ color: '#355F7A' }}>Visitor FAQ</a>,{' '}
            <a href="https://link.sanquentinskunkworks.org/SQRules" target="_blank" rel="noopener noreferrer" className="font-semibold hover:underline" style={{ color: '#355F7A' }}>Visitor Rules</a>,{' '}
            <a href="https://link.sanquentinskunkworks.org/SQDressCode" target="_blank" rel="noopener noreferrer" className="font-semibold hover:underline" style={{ color: '#355F7A' }}>Dress Code</a>
          </p>
        </div>

        <div className="mb-16 text-center">
          <h3 className="text-2xl font-semibold mb-4" style={{ color: '#1F2933' }}>Why We Ask for This Information</h3>
          <p className="mb-4" style={{ color: '#1C3D5A' }}>CDCR requires certain information to run a mandatory background check for entry into the facility.</p>
          <p className="mb-2" style={{ color: '#1C3D5A' }}>San Quentin SkunkWorks also uses your contact information to:</p>
      ...
      <footer className="border-t mt-20 py-8" style={{ borderColor: '#E6E1D8' }}>
        <div className="max-w-4xl mx-auto px-6 text-center text-sm" style={{ color: '#1C3D5A' }}>
          ...
          <p className="mb-2">
            ...
            <a href="mailto:clearance@sanquentinskunkworks.org" className="font-semibold hover:underline" style={{ color: '#355F7A' }}>clearance@sanquentinskunkworks.org</a>
            {' '}(we typically respond within one business day)
          </p>
          <p className="mb-2">
            Having trouble with this form? Use the legacy gate clearance form:{' '}
            <a href="https://link.sanquentinskunkworks.org/gate-clearance" target="_blank" rel="noopener noreferrer" className="font-semibold hover:underline" style={{ color: '#355F7A' }}>https://link.sanquentinskunkworks.org/gate-clearance</a>
          </p>
          <p className="mb-4">
            Technical issues (login, errors, page not loading): 📧{' '}
            <a href="mailto:codeworks@sanquentinskunkworks.org" className="font-semibold hover:underline" style={{ color: '#355F7A' }}>codeworks@sanquentinskunkworks.org</a>
          </p>
